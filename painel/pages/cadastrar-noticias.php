<div class="box-content">
    <h2><i class="fa fa-pencil"></i> Cadastrar Notícias</h2>
    ...
    <?php 
            ...
            if(isset($_POST['acao'])){
                ...
                if($titulo == '' || $conteudo == ''){
                    ...
                    if(Painel::imagemValida($capa)){
                        $verifica = Msql::conectar()->prepare("SELECT * FROM `tb_site.noticias` WHERE titulo = ? AND categoria_id = ?");
                        $verifica->execute(array($titulo,$categoria_id));
                        if($verifica->rowCount() == 0){
                        $imagem = Painel::uploadFiles($capa);
                        ...
                        Painel::alert('erro','A selecione uma imagem válida!');
                    }
            ...
            if(isset($_GET['sucesso']) && !isset($_POST['acao'])){
                Painel::alert('sucesso','Ocadastro foi realizado com sucesso');
            }
        ?>
